package lab9.MailingSubscriber;
...
class MailingListUser implements User{
    ...
    public void notify(String mailingListName, String text) {
        System.out.println(String.format("[USER] %s received email from %s: %s",name,mailingListName,text));
    }
}

class FilteredMailingListUser extends MailingListUser {
    ...
    public void notify(String mailingListName, String text) {
        if (text.toLowerCase().contains(keyword.toLowerCase())){
            System.out.println(String.format("[FILTERED USER] %s received filtered email from %s: %s",name,mailingListName,text));
        }

    }
}

class AdminUser extends MailingListUser{
    ...
    @Override
    public void notify(String mailingListName, String text) {
        System.out.println(String.format("[ADMIN LOG] MailingList=%s | Message=%s",mailingListName,text));
